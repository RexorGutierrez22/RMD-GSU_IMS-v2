    ...
    <div class="container">
        ...
        <div class="credentials-section">
            ...
            <div class="credential-item">
                ...
                <span class="credential-value">{{ $student->contact_number }}</span>
            </div>
            <p style="margin-top: 15px; font-size: 13px; color: #856404;">
                <strong>Note:</strong> You can use your Student ID, Email, or Contact Number along with your Contact Number to authenticate and access the system.
            </p>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <span>{{ $student->first_name }} {{ $student->middle_name ? $student->middle_name . ' ' : '' }}{{ $student->last_name }}</span>
            </div>
            <div class="info-row">
