...
<head>
    ...
    <title>Item Due Today Reminder</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="alert-box">
            <strong>⏰ Urgent Reminder:</strong> Your borrowed item is <strong>due for return TODAY</strong>. Please return it as soon as possible to avoid it becoming overdue.
        </div>
        ...
        <div class="item-details">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">
                    <strong style="color: #dc2626;">{{ $transaction->expected_return_date->format('F d, Y') }}</strong>
        ...
        <div style="background-color: #fef2f2; padding: 15px; border-radius: 6px; margin: 20px 0;">
            ...
            <ul style="margin: 10px 0; padding-left: 20px;">
                <li>Please return the borrowed item(s) <strong>today</strong> before the end of business hours</li>
                <li>Ensure the item(s) are in good condition</li>
                <li>Contact the Resource Management Division immediately if you need to extend the return date</li>
                <li>Failure to return today may result in the item being marked as overdue</li>
            </ul>
        </div>
